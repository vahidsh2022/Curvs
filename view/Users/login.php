                    ...
                    <div class="login-box">
                        ...
                        <div class="login-box-body">
                            ...
                            <form action="<?php echo SAP_SITE_URL . '/login_user/'; ?>" method="post">
                                ...
                                <div class="form-group has-feedback password-area">
                                    <label>Password</label>
                                    <input type="password" id="user_password" name="user_password" oninvalid="this.setCustomValidity('please enter the password')" oninput="setCustomValidity('')" value="<?php echo ( !empty( $password ) ) ? $password : ''; ?>" class="form-control" placeholder="<?php echo $sap_common->lang('password'); ?>" required="" tabindex="2">                                    
                                    <!-- <span class="glyphicon glyphicon-lock form-control-feedback"></span> -->
                                    <div class="checkbox" style="margin-top: 10px;" id="showPassword">
                                        <label><input type="checkbox" onclick="togglePassword()"><i id="showPasswordIcon" class="fa fa-eye-slash"></i></label></div>
                                    </div>
                                    <script>
                                        function togglePassword() {
                                            let pwdField = document.getElementById("user_password");
                                            let showPassword = document.getElementById("showPasswordIcon");
