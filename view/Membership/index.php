...
<script type="text/javascript" class="init">
	...
	$(document).ready(function () {
		...
		var dtListUsers =  $('#list-members').DataTable({
        	...
        	"dom": 'lrtip', 
		    "columnDefs": [	         
	            {"targets": 0, "name": "number", 'searchable': true, 'orderable': false},
	            {"targets": 1, "name": "membership_level", 'searchable': true, 'orderable': false},
				{"targets": 2, "name": "customer_name", 'searchable': true, 'orderable': true},
	            {"targets": 3, "name": "status", 'searchable': true, 'orderable': true},
	            {"targets": 4, "name": "recurring", 'searchable': false, 'orderable': true},
	            {"targets": 5, "name": "expiration", 'searchable': false, 'orderable': true},
	            {"targets": 6, "name": "created_date", 'searchable': false, 'orderable': true},
