    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                //Active tab check
                $active_tab = !empty($_SESSION['sap_active_tab']) ? $_SESSION['sap_active_tab'] : $networks[array_key_first($networks)];

                if (!in_array($active_tab, $networks)) {
                    $active_tab = '';
                } ?>
                <form class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/bots/update/' . $this->bot->id; ?>">
                    <!-- Custom Tabs -->
