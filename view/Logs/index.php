                                        ...
                                        <tr aria-data-id-table="<?php echo $log->id; ?>" id="log_<?php echo $log->id; ?>">
                                            ...
                                            <td>
                                                ...
                                                <td class="action_icons">
                                                    <a href="javascript:void(0)" data-toggle="tooltip" title="View" data-placement="top" aria-data-id="<?php echo $log->id; ?>" class="log_view_details" data-toggle="modal" ><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                    <a class="delete_post" data-toggle="tooltip" title="Delete" data-placement="top" aria-data-id="<?php echo $log->id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
