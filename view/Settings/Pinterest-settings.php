...
$pinterest_count = isset($networks_count['pinterest'])?$networks_count['pinterest']:"";
...
<div class="tab-pane <?php echo ( $active_tab == "pinterest") ? "active" : "" ?>" id="pinterest">
    <form id="pinterest-settings" class="form-horizontal" method="POST" action="<?php echo SAP_SITE_URL . '/settings/save/'; ?>" enctype="multipart/form-data"> 
                ...
                <div class="sap-box-inner">
                    <div class="form-group mb-0">
                        ...
                        <div class="tg-list-item col-sm-6">
                            ...
                            <span><?php echo $sap_common->lang('en_autopost_pit_help'); ?></span>
                        </div>
                ...
                <div class="sap-box-inner">
                    <div class="form-group">
                        ...
                        <div class="tg-list-item col-sm-9">
                            ...
                            <span><?php echo $sap_common->lang('pit_proxy_enable_help'); ?></span>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <label for="pit_proxy_url" class="col-sm-3 control-label padding-top-0"><?php echo $sap_common->lang('pit_proxy_url'); ?></label>
                             <div class="col-sm-6">
                                ...
                                <span><?php echo $sap_common->lang('pit_proxy_url_help'); ?></span>
                            </div>  
                        </div>
                        <div class="form-group">
                            <label for="pit_proxy_username" class="col-sm-3 control-label padding-top-0"><?php echo $sap_common->lang('pit_proxy_username'); ?></label>
                             <div class="col-sm-6">
                                ...
                                <span><?php echo $sap_common->lang('pit_proxy_username_help'); ?></span>
                            </div>  
                        </div>
                        <div class="form-group">
                            <label for="pit_proxy_password" class="col-sm-3 control-label padding-top-0"><?php echo $sap_common->lang('pit_proxy_password'); ?></label>
                             <div class="col-sm-6">
                                ...
                                <span><?php echo $sap_common->lang('pit_proxy_password_help'); ?></span>
                            </div>  
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12  ">
                        ...
                        $limit_note = ''; $limit_note = '';
                                 if($pinterest_count < 2) {

                                        $limit_note = sprintf($sap_common->lang('single_account_limit_note'),'<span class="limit-note"><strong>','</strong></span>',$pinterest_count);
                                    } else if($pinterest_count > 1) {
                                        $limit_note = sprintf($sap_common->lang('max_account_limit_note'),'<span class="limit-note"><strong>','</strong></span>',$pinterest_count);
                                    }
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input id="app_api1" type="radio" name="sap_pinterest_options[pin_auth_options]" <?php echo($pinterest_auth_options == 'app' || $pinterest_auth_options == '') ? 'checked="checked"' : ''; ?> value="app">
                                <label class="auth-option" for="app_api1"><?php echo $sap_common->lang('pit_app_method'); ?></label>
                            </div>
                            <div class="col-sm-3">
                                <input id="cookie_api1" type="radio" name="sap_pinterest_options[pin_auth_options]" <?php echo($pinterest_auth_options == 'cookie') ? 'checked="checked"' : ''; ?> value="cookie">
                                <label class="auth-option" for="cookie_api1"><?php echo $sap_common->lang('pit_cookie_method'); ?></label>
                            </div>
                    </div>
                    <div style="<?php print $app_style; ?>" id="app-method-wrap">
                        ...
                        <div class="alert alert-info linkedin-multi-post-note documentation-text tooltip-wrap">
                            <!-- <i> -->
                            <i class="glyphicon  glyphicon-info-sign"></i><?php echo sprintf($sap_common->lang('pit_notice_help_text'),'<strong>','</strong>'); ?>
                            <!-- </i> -->
                            <!-- <br/> -->
                            <a href="<?php echo SAP_SITE_URL.'/settings/'; ?>"><?php echo SAP_SITE_URL.'/settings/'; ?></a>
                        </div>
                        ...
                        ?>
                         <input type="hidden" name="limit_pinterest_count" id="limit_pinterest_count" value="<?php echo $pinterest_count;?>" />
					     <input type="hidden" name="created_pinterest_count" id="created_pinterest_count" value="<?php echo count($sap_pin_keys);?>" />


                         <?php
                                    
                            if( count($sap_pin_keys) >= $pinterest_count && $pinterest_count > 0){
                                $limit_alert = '';
                                if($pinterest_count < 2) {

                                    $limit_alert = sprintf($sap_common->lang('single_account_limit_alert'),'<span class="limit-note">','</span>',$pinterest_count);
                                } else if($pinterest_count > 1) {
                                    $limit_alert = sprintf($sap_common->lang('max_account_limit_alert'),'<span class="limit-note">','</span>',$pinterest_count);
                                }
                                ?>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="sap-box-inner sap-api-pinterest-settings">
                    <div class="form-group pt-selector">
                        ...
                        <div class="col-sm-6">
                            ...
                            <span><?php echo $sap_common->lang('autopost_to_pit_users_help'); ?></span>
                             <div class="button-Select sap-mt-1">
                                <button type="button" name="sap_facebook_submit" class="btn btn-primary select_all m-r-10" data-parent="pt-selector"> Select All</button>
                                <button type="button" class="btn btn-light deselect_all" data-parent="pt-selector">Select None</button>
                            </div>
                        </div>
                        <!-- <div class="col-sm-3">
                            <button type="button" name="sap_facebook_submit" class="btn btn-primary select_all" data-parent="pt-selector"> Select All</button>
                            <button type="button" class="btn btn-light deselect_all" data-parent="pt-selector">Select None</button>
                        </div> -->
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 sap-pin-img-wrap <?php echo (!empty($sap_pinterest_options['pin_image'])) ? 'pin-hide-uploader' : '';?>">
                            ...
                            <div class="alert alert-info linkedin-multi-post-note">
                                <?php echo sprintf( $sap_common->lang('pit_post_img_help_text'), '<span><strong>', '</strong></span>' ); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php
                    //Get SAP options which stored
                    $sap_options = $this->get_user_setting('sap_pinterest_options');
                    $sap_options_count = isset($networks_count['pinterest']) ? $networks_count['pinterest'] : "";
                    $sap_options_network = $network;
                    $sap_options_network_docs_url = 'https://developers.pinterest.com/docs/overview/welcome/';
