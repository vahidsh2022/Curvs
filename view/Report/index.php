    ...
    <section class="content-header">
        <h1>
            <span class="d-flex flex-wrap align-items-center">
                                <span class="margin-r-5"><i class="fa fa-pie-chart"></i></span>
                                ...
                                <select name="sap_graph_social_type" class="form-control" id="sap_graph_social_type" data-placeholder="Show all social type">
                                    ...
                                    if (!empty($social_types)) { // Check social types are not empty
                                        foreach ($social_types as $social_key => $social_name) {
                                            if($social_name === 'crod' || $social_name === 'crud') {
                                                continue;
                                            }
...
<script>
    jQuery(function () {
        $('#sap_graph_social_type').prop('selectedIndex', 1);
        setTimeout(() => {
            $('#sap_graph_social_type').prop('selectedIndex', 0);
        }, 100);
    })
</script>