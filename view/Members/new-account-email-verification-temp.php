                     ...
                     <td class="email-masthead" style="vertical-align: middle;">
                        <div style="display: flex;">
                           <a href="<?php echo SAP_SITE_URL; ?>" style="display: flex;
                              display: flex; align-items: center; margin: 0 auto;" class="email-masthead_name">

                        <?php if(!empty($this->setting->get_options('mingle_logo'))){ ?>
                         <img style="width: 150px;" src="<?php echo SAP_SITE_URL .'/assets/images/Mingle-Logo.svg'; ?>" class="mingle-logo" />

                            <?php }else{ ?>
                              
                         <img style="width: 150px;" src="<?php echo SAP_SITE_URL .'/assets/images/mingle-logo.png'; ?>" class="mingle-logo" />
                            <?php }?>
                              <p style="margin-bottom: 0;margin-top: 15px;margin-left: 2px;color: #2f5aa9;font-weight: bold;font-size: 20px;"><?php echo empty( $this->setting->get_options('mingle_site_name') ) ? SAP_NAME : $this->setting->get_options('mingle_site_name');; ?></p>
                           </a>
                        </div>
                     </td>
                  </tr>
                           ...
                           <tr>
                              <td class="content-cell">
                                 <?php
                                    ...
                                    <?php echo sprintf($sap_common->lang('new_account_email_temp_username_text'),'<h3>',$userName,'</h3>','<p>','</p>'); ?>

                                 <?php                                
                                 $verification_link = SAP_SITE_URL.'/email/'.$email_verification_tokan .'/';
                                 ?>
                                 <p>
                                    <a class="button-green" href="<?php echo $verification_link ?>"><?php echo $sap_common->lang('verify_now'); ?></a>
                                 </p>
