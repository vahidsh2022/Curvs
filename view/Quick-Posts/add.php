...
if(@$match['params']['cpg_id']) {
    $cpg = $this->cpgRow;
    $post_data = (object) [
            'message' => $cpg->new_message ?: $cpg->original_message,
        'image' =>  $cpg->new_image ?: $cpg->orginal_image,
        'share_link' => 'unknown'
    ];
}

echo 'yes';
echo json_encode($sap_twitter_options['enable_twitter']);
?>
    ...
    <section class="content-header content-header-quick-post d-flex justify-content-between">
        ...
        <?php if (isset($match['params']['id']) && !empty($match['params']['id'])) { ?>
            <a href="<?php echo $router->generate('quick_posts'); ?>"
               class="btn btn-primary add-new-quick-post"><?php echo $sap_common->lang('add_new'); ?></a>
        <?php } ?>
    </section>
    ...
    <section class="content sap-quick-post">
        <div class="row">
            ...
            <?php if (!isset($match['params']['id'])) { ?>
                <form action="<?php echo $router->generate('quick_save_post'); ?>" id="quick-post-form"
                      class="quick-post" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-left" style="background-color: #fff !important;">
                        ...
                        <div class="sap-tab-nav-wrap ">
                            <ul class="nav nav-tabs">
                                <li class="msg-li <?php echo $custom_message_li_active; ?>">
                                    <a href="#" class="sap-message-tab-nav <?php echo $custom_message_tab_active; ?>"
                                       id="sap-custom-message"><?php echo $sap_common->lang('custom_message'); ?></a>
                                </li>
                                <?php if (!empty($chat_gpt_api_key)) { ?>
                                    <li class="msg-li <?php echo $ai_message_li_active; ?>">
                                        <a href="#" class="sap-message-tab-nav <?php echo $ai_message_tab_active; ?>"
                                           id="sap-ai-message"><?php echo $sap_common->lang('ai_message'); ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                        <input type="hidden" name="sap-active-tab" class="sap-active-tab">
                        <div class="col-lg-6 sap-custom-tab sap-tab-content sap-message-tab-content <?php echo $custom_message_content_active ?>"
                             id="sap-custom-message">
                            <div class="row">
                                <div class="col-lg-12 sap-msg-wrap">
                                    <label class="message-label control-label"
                                           for="custom-message"><?php echo $sap_common->lang('message'); ?><span
                                                class="astric">*</span></label>
                                    <div class="form-group">
                                        <textarea name="custom-message" id="custom-message"
                                                  class="quick-post-message form-control" rows="5"
                                                  placeholder="Write something here..."><?php echo !empty($post_data->message) ? strip_tags($post_data->message) : ''; ?></textarea>
                                        <div class="custom-char-count"><span
                                                    id="char-count">0</span> <?php echo $sap_common->lang('char_count'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 sap-tab-content sap-message-tab-content <?php echo $ai_message_content_active ?>"
                             id="sap-ai-message">
                            <img src="<?php echo SAP_SITE_URL . '/assets/images/ajax-loader.gif'; ?>"
                                 id="sap-caption-loader" class="sap-caption-loader-img">
                            <div class="row sap-ai-div">
                                <div class="col-lg-12 form-group sap-share-link-parent">
                                    <label class="control-label" id="sap-share-link-parent-link"
                                           for="ai_share_link"><?php echo $sap_common->lang('link'); ?><span
                                                class="astric">*</span></label>
                                    <span id="sap_caption_link_error_msg" class="sap_caption_link_error_msg"></span>
                                    <input class="form-control sap-ai-link" tabindex="4"
                                           placeholder="Content share link" name="ai_share_link" id="ai_share_link"
                                           value="<?php echo !empty($post_data->share_link) ? $post_data->share_link : ''; ?>">
                                </div>
                                <div class="col-lg-12 sap-msg-wrap">
                                    <label class="message-label control-label"
                                           for="quick-post-ai-message"><?php echo $sap_common->lang('message'); ?><span
                                                class="astric">*</span></label>
                                    <span id="sap_caption_error_msg" class="sap_caption_error_msg"></span>
                                    <div class="form-group">
                                        <textarea name="ai-message" id="quick-post-ai-message"
                                                  class="quick-post-message quick-post-ai-message form-control" rows="5"
                                                  placeholder="AI message here..."><?php echo !empty($post_data->message) ? strip_tags($post_data->message) : ''; ?></textarea>
                                    </div>
                                    <div class="form-group caption-words">
                                        <div class=""
                                            ...
                                            <div class="sap-caption-words-wrap col-md-6" style="padding-left: 0;">
                                                ...
                                                <input type="number" name="sap_caption_words" id="sap_caption_words"
                                                       value="<?php echo !empty($sap_caption_words) ? $sap_caption_words : 30; ?>"
                                                       class="sap-caption-words form-control">
                                                <label for="sap_caption_words"> <?php echo $sap_common->lang('caption_words'); ?> </label>

                                            </div>
                                            <div class="col-md-4" style="padding-right: 0;">
                                                <input type="button" class="sap-ai-caption-btn btn btn-success"
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <h4 class="box-title">
                                    <div class="col-sm-12">
                                        <label for="enable-image-video"
                                               class=" control-label padding-top-0"><?php echo $sap_common->lang('video'); ?></label>
                                    </div>
                                    <div class="col-sm-12 box-radio-wrap">
                                        <div class="image-video-select">
                                            <input id="enable_image" type="radio"
                                                   name="enable_video_image" <?php echo 'checked="checked"'; ?>
                                                   value="enableimage">
                                        ...
                                        <div class="image-video-select" style="display: none">
                                            <input id="enable_media" type="radio" name="enable_video_image"
                                                   value="enablemedia">
                                            <label class="enable_image"
                                                   for="enable_media"><?php echo $sap_common->lang('media_label'); ?></label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12 quick-image-wrap 123">
                                    ...
                                    <div class="form-group">
                                        <?php if ($this->cpgRow) { ?>
                                            <input type="hidden" name="image_url" value="<?php echo SAP_IMG_URL . $post_data->image; ?>">
                                        <?php } ?>
                                        <?php if (!empty($post_data->image)) { ?>
                                            <input id="quick-post-image" tabindex="3" value="" name="image" type="file"
                                                   class="file file-loading" data-show-upload="false"
                                                   data-show-caption="true"
                                                   data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]'
                                                   data-max-file-size="<?php echo MINGLE_MAX_FILE_UPLOAD_SIZE; ?>"
                                                   data-initial-preview="<img src='<?php echo (SAP_IMG_URL . $post_data->image); ?>' class='uploaded-img'/>">
                                        <?php } else { ?>
                                            <input id="quick-post-image" tabindex="3" value="" name="image" type="file"
                                                   class="file file-loading" data-show-upload="false"
                                                   data-show-caption="true"
                                                   ...
                                                   data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]'/>
                                        <?php } ?>
                                        <input type="hidden" id="featured-img" name="image"
                                               value="<?php echo(!empty($post_data->image) ? $post_data->image : 0); ?>"
                                               data-max-file-size="1M">
                                    </div>
                                    <?php if (!empty($sap_facebook_options['fb_app_version']) && $sap_facebook_options['fb_app_version'] >= 2.9) { ?>
                                        <div class="alert alert-warning sap-warning"><i class="fa fa-info-circle"
                                                                                        aria-hidden="true"></i> <?php echo $sap_common->lang('quick_post_image_help_text'); ?>
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="col-lg-12 quick-video-wrap">
                                    <!-- <label class="control-label"><?php echo $sap_common->lang('video_label'); ?></label> -->
                                    <input id="quick-post-video" tabindex="3" value="" name="video" type="file"
                                           class="file file-loading" data-show-upload="false" data-show-caption="true"
                                           data-max-file-size="<?php echo MINGLE_MAX_VIDEO_UPLOAD_SIZE; ?>"
                                           data-allowed-file-extensions='["mp4"]'/>
                                </div>
                                <div class="video-label-notification">
                                    <div class="alert alert-info note-text">Note: Video Posting is only supported with
                                        Quick Share to these 5 Social Media : Twitter, Facebook, Tumblr, Youtube and
                                        Instagram ( Reel Posting ).
                                    </div>
                                    <h6><b>Please check allowed video formats and standards <a target="_blank"
                                                                                               href="https://docs.wpwebelite.com/mingle-saas/social-network-configuration/#Quickshare-video">here.</a></b>
                                    </h6>
                                </div>
                                <div  class="col-lg-12 quick-media-wrap" >
...
<!--                                        <label class="control-label" id="sap-share-link-parent-link"-->
<!--                                               for="custom_share_link">--><?php //echo $sap_common->lang('link'); ?><!--</label>-->
<!--                                        <input class="form-control sap-quick-valid-url" tabindex="4"-->
<!--                                               placeholder="Content share link" name="custom_share_link"-->
                                        ...
                                        <div class="box-group custom-accordion" id="accordion">
                                                ...
                                                <div class="panel box fb-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_facebook"
                                                                   class="tgl tgl-ios" <?php echo !empty($post_meta['facebook']) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[facebook]" id="enable_facebook"
                                                                   type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_facebook"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <div id="quick_post_facebook" class="panel-collapse collapse"
                                                        ...
                                                        <?php } else {
                                                            ...
                                                            ?>
                                                            <div class="networks-wrap  fb-selector">
                                                                <label for="sap_fb_user_id"
                                                                       class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                                <select class="form-control sap_select" tabindex="6"
                                                                        name="networks[fb_accounts][]"
                                                                        multiple="multiple" id="sap_fb_user_id"
                                                                        ...
                                                                        foreach ($fb_accounts as $aid => $aval) {
                                                                            ...
                                                                            if (is_array($aval)) {
                                                                                ...
                                                                                foreach ($aval as $aval_key => $aval_data) {
                                                                                    ?>
                                                                                    <option <?php echo in_array($aval_key, $fb_type_post_user) ? 'selected="selected"' : ''; ?>
                                                                                            value="<?php echo $aval_key; ?>"><?php echo $aval_data; ?></option>
                                                                                <?php } ?>
                                                                            <?php } else {
                                                                                ?>
                                                                                <option <?php echo in_array($aid, $fb_type_post_user) ? 'selected="selected"' : ''; ?>
                                                                                        value="<?php echo $aid; ?>"><?php echo $aval; ?></option>
                                                                                <?php
                                                                            }
                                                                        } // End of foreach
                                                                    } // End of main if
                                                                ...
                                                                <div class="select-button">
                                                                    <br>
                                                                    <button type="button"
                                                                            class="btn btn-light deselect_all"
                                                                            data-parent="fb-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                    <button type="button" name="sap_facebook_submit"
                                                                            class="btn btn-primary select_all"
                                                                            data-parent="fb-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                                </div>
                                                            </div>
                                                            <!-- Added Posting type -->
                                                            <div class="share-type-wrap  fb-selector">
                                                                <label for="sap_fb_posting_type"
                                                                       class="control-label"><?php echo $sap_common->lang('share_posting_type'); ?></label>
                                                                <?php
                                                                ...
                                                                ?>
                                                                <select class="form-control sap_select"
                                                                        id="sap_fb_posting_type"
                                                                        name="networks[fb_posting_type]">
                                                                    <?php
                                                                    foreach ($share_posting_type as $type => $share_posting_type) {
                                                                        ?>
                                                                        <option value="<?php echo $type ?>"><?php echo $share_posting_type ?></option>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                            ...
                                                            <div class="sap-individual-time ">
                                                                <label for="sap-schedule-time-fb"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-fb"
                                                                       id="sap-schedule-time-fb" <?php echo !empty($sap_schedule_time_fb) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_fb) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            ...
                                            if (!empty($sap_twitter_options['enable_twitter'])) {
                                                ...
                                                <div class="panel box tw-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_twitter"
                                                                   class="tgl tgl-ios"
                                                                   name="networks[twitter]" <?php echo !empty($post_meta['twitter']) ? 'checked="checked"' : ''; ?>
                                                                   id="enable_twitter" type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_twitter"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    $style = !empty($post_meta['twitter']) ? 'display:block;' : 'display:none;';
                                                    ?>
                                                    <div id="quick_post_twitter"
                                                         class="panel-collapse collapse tw-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <label for="sap_twitter_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="14"
                                                                    name="networks[tw_accounts][]" multiple="multiple"
                                                                    id="sap_twitter_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                if (!empty($sap_twitter_accounts_details)) {
                                                                    $twitter_count = $networks_count['twitter'];
                                                                    $tw_count = 1;
                                                                    foreach ($sap_twitter_accounts_details as $key => $profile_details) {
                                                                        $selected = "";
                                                                        if ($tw_count > $twitter_count && $twitter_count > 0) {
                                                                            break;
                                                                        }
                                                                        $tw_count++;
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="tw-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="tw-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-tw"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-tw"
                                                                       id="sap-schedule-time-tw" <?php echo !empty($sap_schedule_time_tw) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_twitter) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            if (!empty($sap_telegram_options['enable_telegram'])) {
                                                ...
                                                <div class="panel box tg-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        <div><?php echo $sap_common->lang('network_label_telegram'); ?></div>
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_telegram"
                                                                   class="tgl tgl-ios"
                                                                   name="networks[telegram]" <?php echo !empty($post_meta['telegram']) ? 'checked="checked"' : ''; ?>
                                                                   id="enable_telegram" type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                    ...
                                                    ?>
                                                    <div id="quick_post_telegram"
                                                         class="panel-collapse collapse tg-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <label for="sap_telegram_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="14"
                                                                    name="networks[tg_accounts][]" multiple="multiple"
                                                                    id="sap_telegram_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                if (!empty($sap_telegram_accounts_details)) {
                                                                    $telegram_count = $networks_count['telegram'];
                                                                    $tg_count = 1;
                                                                    foreach ($sap_telegram_accounts_details as $key => $profile_details) {
                                                                        $selected = "";
                                                                        if ($tg_count > $telegram_count && $telegram_count > 0) {
                                                                            break;
                                                                        }
                                                                        $tg_count++;

                                                                        if (!empty($post_meta['tg_accounts']) && in_array($key, $post_meta['tg_accounts'])) {
                                                                            $selected = ' selected="selected"';
                                                                        }
                                                                        ?>
                                                                        <option value="<?php echo $key; ?>"<?php print $selected; ?>><?php echo $profile_details['name']; ?></option>
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="tg-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="tg-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-tg"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-tg"
                                                                       id="sap-schedule-time-tg" <?php echo !empty($sap_schedule_time_tw) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_telegram) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            if (!empty($sap_youtube_options['enable_youtube']) /*true*/) {
                                                ...
                                                <div class="panel box yt-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_youtube"
                                                                   class="tgl tgl-ios"
                                                                   name="networks[youtube]" <?php echo !empty($post_meta['youtube']) ? 'checked="checked"' : ''; ?>
                                                                   id="enable_youtube" type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_youtube"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    $style = !empty($post_meta['youtube']) ? 'display:block;' : 'display:none;';
                                                    ?>
                                                    <div id="quick_post_youtube"
                                                         class="panel-collapse collapse yt-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <label for="sap_youtube_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="14"
                                                                    name="networks[youtube_accounts][]"
                                                                    multiple="multiple" id="sap_youtube_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                ...
                                                                if (!empty($sap_youtube_options['youtube_keys'])) {
                                                                    $youtube_count = $networks_count['youtube'];
                                                                    $you_count = 1;
                                                                    foreach ($sap_youtube_options['youtube_keys'] as $youtube_keys) {
                                                                        if ($you_count > $youtube_count && $youtube_count > 0) {
                                                                            break;
                                                                        }
                                                                        $you_count++;
                                                                        foreach ($youtube_keys as $profile_id => $profile_name) {
                                                                            ...
                                                                            if ($profile_id == 'consumer_key' && !empty($sap_youtube_sess_data[$yt_user_id])) {
                                                                                ?>
                                                                                <option
                                                                                value="<?php echo $profile_name; ?>" <?php echo in_array($profile_name, $yt_type_post_user) ? 'selected=selected' : ''; ?>><?php echo $profile_name; ?></option><?php
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="yt-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="yt-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-youtube"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-youtube"
                                                                       id="sap-schedule-time-youtube" <?php echo !empty($sap_schedule_time_youtube) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_youtube) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            if (!empty($sap_linkedin_options['enable_linkedin'])) {
                                                ...
                                                <div class="panel box li-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_linkedin"
                                                                   class="tgl tgl-ios"
                                                                   name="networks[linkedin]" <?php echo !empty($post_meta['linkedin']) ? 'checked="checked"' : ''; ?>
                                                                   id="enable_linkedin" type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_linkedin"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    $style = !empty($post_meta['linkedin']) ? 'display:block;' : 'display:none;';
                                                    ?>
                                                    <div id="quick_post_linkedin"
                                                         class="panel-collapse collapse li-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <label for="sap_linkedin_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select width-100"
                                                                    id="sap_linkedin_user_id"
                                                                    name="networks[li_accounts][]" multiple="multiple"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                $li_profile_data = $linkedin->sap_li_get_profiles_data();
                                                                $linkedin_count = $networks_count['linkedin'];

                                                                if (!empty($li_profile_data)) {
                                                                    $linked_count = 1;
                                                                    foreach ($li_profile_data as $profile_id => $profile_name) {
                                                                        if ($linked_count > $linkedin_count && $linkedin_count > 0) {
                                                                            break;
                                                                        }
                                                                        $linked_count++;
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="li-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="li-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-li"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-li"
                                                                       id="sap-schedule-time-li" <?php echo !empty($sap_schedule_time_li) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_li) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                            ...
                                            if (!empty($sap_tumblr_options['enable_tumblr'])) {
                                                ...
                                                <div class="panel box tum-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_tumblr" class="tgl tgl-ios"
                                                                   name="networks[tumblr]" <?php echo !empty($post_meta['tumblr']) ? 'checked="checked"' : ''; ?>
                                                                   id="enable_tumblr" type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_tumblr"></label>
                                                        </div>
                                                    </h4>
                                                    ...
                                                    ?>
                                                    <div id="quick_post_tumblr"
                                                         class="panel-collapse collapse tb-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <label for="sap_tumblr_user_id"
                                                                   class="location-label control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="14"
                                                                    name="networks[tumblr_accounts][]"
                                                                    multiple="multiple" id="sap_tumblr_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                if (!empty($sap_tumblr_account_details) && is_array($sap_tumblr_account_details)) {
                                                                    $tumblr_count = $networks_count['tumblr'];
                                                                    $tumb_count = 1;
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="tb-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="tb-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <label for="sap_posting_type"
                                                                   class="control-label"><?php echo $sap_common->lang('select_posting_type'); ?></label>
                                                            <select class="form-control" id="sap_posting_type"
                                                                    name="networks[tu_posting_type]">
                                                                <option <?php echo !empty($post_meta['tu_posting_type']) && $post_meta['tu_posting_type'] == 'text' ? 'selected="selected"' : ''; ?>
                                                                        value="text"><?php echo $sap_common->lang('text'); ?></option>
                                                                <option <?php echo !empty($post_meta['tu_posting_type']) && $post_meta['tu_posting_type'] == 'link' ? 'selected="selected"' : ''; ?>
                                                                        value="link"><?php echo $sap_common->lang('link'); ?></option>
                                                                <option <?php echo !empty($post_meta['tu_posting_type']) && $post_meta['tu_posting_type'] == 'photo' ? 'selected="selected"' : ''; ?>
                                                                        value="photo"><?php echo $sap_common->lang('photo'); ?></option>
                                                                <option <?php echo !empty($post_meta['tu_posting_type']) && $post_meta['tu_posting_type'] == 'video' ? 'selected="selected"' : ''; ?>
                                                                        value="video"><?php echo $sap_common->lang('video_label'); ?></option>
                                                            </select>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-tumblr"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-tumblr"
                                                                       id="sap-schedule-time-tumblr" <?php echo !empty($sap_schedule_time_tumblr) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_tumblr) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                        <?php } ?>
                                            ...
                                            if (!empty($sap_pinterest_options['enable_pinterest'])) {
                                                ...
                                                <div class="panel box pin-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_pinterest"
                                                                   class="tgl tgl-ios" <?php echo !empty($post_meta['pinterest']) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[pinterest]" id="enable_pinterest"
                                                                   type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_pinterest"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    $style = !empty($post_meta['pin_accounts']) ? 'display:block;' : 'display:none;';
                                                    ?>
                                                    <div id="quick_post_pinterest"
                                                         class="panel-collapse collapse pt-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <label for="sap_pin_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[pin_accounts][]" multiple="multiple"
                                                                    id="sap_pin_user_id" data-placeholder="Select User">
                                                                <?php
                                                                ...
                                                                if (!empty($pin_accounts) && is_array($pin_accounts)) {
                                                                    $pinterest_count = $networks_count['pinterest'];
                                                                    $pin_type_post_user = (!empty($post_meta['pin_accounts'])) ? $post_meta['pin_accounts'] : array();
                                                                    $pin_count = 1;
                                                                    foreach ($pin_accounts as $aid => $aval) {
                                                                        if ($pin_count > $pinterest_count && $pinterest_count > 0) {
                                                                            break;
                                                                        }
                                                                        $pin_count++;
                                                                        ?>

                                                                        <option <?php echo in_array($aid, $pin_type_post_user) ? 'selected="selected"' : ''; ?>
                                                                                value="<?php echo $aid; ?>"><?php echo $aval; ?></option>
                                                                        <?php
                                                                    } // End of foreach
                                                                } // End of main if
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="pt-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="pt-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-pin"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-pin"
                                                                       id="sap-schedule-time-pin" <?php echo !empty($sap_schedule_time_pin) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_pin) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetim">
                                                            </div>
                                            ...
                                            <?php if (!empty($sap_gmb_options['enable_google_business'])) {
                                                ...
                                                <div class="panel box gmb-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_gmb"
                                                                   class="tgl tgl-ios" <?php echo !empty($post_meta['gmb']) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[gmb]" id="enable_gmb" type="checkbox"
                                                                   value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_gmb"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    $style = !empty($post_meta['gmb']) ? 'display:block;' : 'display:none;';
                                                    ?>
                                                    <div id="quick_post_gmb"
                                                         class="panel-collapse collapse gmb-selector"
                                                         style="<?php echo $style; ?>">
                                                        <?php if (empty($sap_auto_poster_gmb_sess_data)) { ?>
                                                            ...
                                                            ?>
                                                            <label for="sap_gmb_location_id"
                                                                   class="location-label control-label"><?php echo $sap_common->lang('select_locations'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[gmb_locations][]" multiple="multiple"
                                                                    id="sap_gmb_location_id"
                                                                ...
                                                                if (!empty($gmb_locations) && is_array($gmb_locations)) {
                                                                    ...
                                                                    $gmb_count = 1;
                                                                    $gmb_net_count = $networks_count['gmb'];

                                                                    foreach ($gmb_locations as $aid => $aval) {
                                                                        if ($gmb_count > $gmb_net_count && $gmb_net_count > 0) {
                                                                            break;
                                                                        }
                                                                        $gmb_count++;

                                                                        ?>
                                                                        <option <?php echo in_array($aid, $gmp_type_locations) ? 'selected="selected"' : ''; ?>
                                                                                value="<?php echo $aid; ?>"><?php echo $aval; ?></option>
                                                                        <?php
                                                                    } // End of foreach
                                                                } // End of main if
                                                            ...
                                                            <br/><br/>
                                                            <label for="sap_gmb_button_type"
                                                                   class="control-label"><?php echo $sap_common->lang('select_btn_type'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[gmb_button_type]"
                                                                    id="sap_gmb_btn_type_id"
                                                                    data-placeholder="Select Button Type">
                                                                <?php
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="gmb-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="gmb-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-gmb"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-gmb"
                                                                       id="sap-schedule-time-gmb" <?php echo !empty($sap_schedule_time_gmb) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_gmb) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                            <div class="alert alert-info linkedin-multi-post-note">
                                                                <!-- <i> -->
                                            ...
                                            if (!empty($sap_instagram_options['enable_instagram'])) {
                                                ...
                                                <div class="panel box insta-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        ...
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_intagram"
                                                                   class="tgl tgl-ios" <?php echo !empty($post_meta['facebook']) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[instagram]" id="enable_instagram"
                                                                   type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_instagram"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <div id="quick_post_intagram"
                                                         class="panel-collapse collapse in-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else {
                                                            ...
                                                            <label for="sap_fb_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[instagram_accounts][]"
                                                                    multiple="multiple" id="sap_fb_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                ...
                                                                if (!empty($insta_accounts) && is_array($insta_accounts)) {
                                                                    ...
                                                                    foreach ($insta_accounts as $aid => $aval) {
                                                                        ...
                                                                        if (is_array($aval)) {
                                                                            ...
                                                                            foreach ($aval as $aval_key => $aval_data) {
                                                                                ?>
                                                                                <option <?php echo in_array($aval_key, $instagram_type_post_user) ? 'selected="selected"' : ''; ?>
                                                                                        value="<?php echo $aval_key; ?>"><?php echo $aval_data ?></option>
                                                                            <?php } ?>
                                                                        <?php } else {
                                                                            ?>
                                                                            <option <?php echo in_array($aid, $instagram_type_post_user) ? 'selected="selected"' : ''; ?>
                                                                                    value="<?php echo $aid; ?>"><?php echo $aval; ?></option>
                                                                            <?php
                                                                        }
                                                                    } // End of foreach
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="in-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="in-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>

                                                            <!-- Added Posting type -->
                                                            <!--<div class="share-type-wrap  inst-selector">
                                                            ...
                                                            ?>
																	<select class="form-control sap_select" id="sap_fb_user_id"  name="sap_share_posting_type_inst">
																		<?php
                                                            foreach ($share_posting_type as $type => $share_posting_type) {
                                                                ?>
																				<option value="<?php echo $type ?>"><?php echo $share_posting_type ?></option>
                                                            ...
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-instagram"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-instagram"
                                                                       id="sap-schedule-time-instagram" <?php echo !empty($sap_schedule_time_instagram) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_instagram) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime">
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            if (!empty($sap_reddit_options['enable_reddit'])) {
                                                ?>
                                                <div class="panel box reddit-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        <div><?php echo $sap_common->lang('network_label_reddit'); ?></div>
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_reddit"
                                                                   class="tgl tgl-ios" <?php echo !empty($post_meta['reddit']) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[reddit]" id="enable_reddit"
                                                                   type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_reddit"></label>
                                                        </div>
                                                    </h4>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <div id="quick_post_reddit"
                                                         class="panel-collapse collapse rd-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            <label for="sap_fb_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[reddit_accounts][]"
                                                                    multiple="multiple" id="sap_reddit_user_id"
                                                                    data-placeholder="Select User">
                                                            <?php
                                                            $reddit_accounts = $reddit->sap_get_reddit_accounts();
                                                            if (!empty($reddit_accounts) && is_array($reddit_accounts)) {
                                                                $reddit_count = $networks_count['reddit'];
                                                                ...
                                                                /* foreach ($reddit_accounts as $uid => $uname) {
                                                                    if( $redt_count > $reddit_count && $reddit_count >0){
                                                                        break;
                                                                    }
                                                                    $redt_count++;
                                                                ...
                                                                if (!empty($subreddits_accounts) && is_array($subreddits_accounts)) {
                                                                    foreach ($subreddits_accounts as $aval_key => $aval_data) {
                                                                        ...
                                                                        ?>
                                                                        <optgroup
                                                                                label="<?php echo $main_account_name; ?>">
                                                                            ...
                                                                            if (!empty($aval_data['subreddits']) && is_array($aval_data['subreddits'])) {
                                                                                foreach ($aval_data['subreddits'] as $sr_key => $sr_data) {
                                                                                    ?>
                                                                                    <?php $selected = (!empty($sap_reddit_post_accounts) && in_array($sr_key, $sap_reddit_post_accounts) ? 'selected="selected"' : '') ?>
                                                                                    <option value="<?php echo $sr_key; ?>" <?php echo $selected; ?> ><?php echo $sr_data; ?></option>
                                                                                <?php }
                                                                            }
                                                                            ?>
                                                                        </optgroup>
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="rd-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="rd-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-reddit"
                                                                       class="control-label"><?php echo $sap_common->lang('schedule_individual'); ?>
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       data-container="body" data-toggle="popover"
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-reddit"
                                                                       id="sap-schedule-time-reddit" <?php echo !empty($sap_schedule_time_reddit) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_reddit) . '"' : ''; ?>
                                                                       class="form-control sap-datetime">
                                                            </div>
                                                        <?php }// End of main if ?>
                                                    </div>
                                                </div>
                                            ...
                                            <?php if (!empty($sap_blogger_options['enable_blogger'])) {
                                                ...
                                                <div class="panel box blogger-wrap">
                                                    <h4 class="box-title d-flex justify-content-between">
                                                        <div><?php echo $sap_common->lang('network_label_blogger'); ?></div>
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_blogger"
                                                                   class="tgl tgl-ios" <?php //echo !empty( $post_meta['blogger'] ) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[blogger]" id="enable_blogger"
                                                                   type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_blogger"></label>
                                                        </div>
                                                    </h4>
                                                    <?php //$style = !empty( $post_meta['blogger'] ) ? 'display:block;' : 'display:none;'; ?>
                                                    <div id="quick_post_blogger"
                                                         class="panel-collapse collapse bl-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <label for="sap_blogger_post_url"
                                                                   class="control-label"><?php echo $sap_common->lang('blogger_post_url'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[blogger_urls][]" multiple="multiple"
                                                                    id="sap_blogger_post_url"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                ...
                                                                if (!empty($blogger_urls) && is_array($blogger_urls)) {
                                                                    ...
                                                                    $blogger_count = $networks_count['blogger'];
                                                                    $blogcnt_count = 1;
                                                                    foreach ($blogger_urls as $Urlkey => $val) {
                                                                        if ($blogcnt_count > $blogger_count && $blogger_count > 0) {
                                                                            break;
                                                                        }
                                                                        $blogcnt_count++;
                                                                        ?>

                                                                        <option <?php echo in_array($val, $blogger_type_post_url) ? 'selected="selected"' : ''; ?>
                                                            ...
                                                            <div class="sap-msg-wrap">
                                                                <label for="sap_blogger_title"
                                                                       class="control-label"><?php echo $sap_common->lang('blogger_custom_message'); ?>
                                                                    <span class="astric">*</span></label>

                                                                <input type="text" name="networks[blogger_title]"
                                                                       class="form-control sap-blogger-title"
                                                                       id="sap_blogger_title" tabindex="5"
                                                                       value="<?php echo (!empty($post_meta['blogger_title'])) ? $post_meta['blogger_title'] : ''; ?>"/>
                                                            </div>

                                                            <label for="sap_fb_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[blogger_accounts][]"
                                                                    multiple="multiple" id="sap_blogger_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                                ...
                                                                if (!empty($blogger_accounts) && is_array($blogger_accounts)) {
                                                                    ...
                                                                    foreach ($blogger_accounts as $uid => $uname) {
                                                                        ...
                                                                        if (!empty($uid)) { ?>
                                                                            ...
                                                                            <option <?php echo in_array($uid, $blogger_type_post_user) ? 'selected="selected"' : ''; ?>
                                                                                    value="<?php echo $uid; ?>"><?php echo $uname; ?></option>
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="bl-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="bl-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-blogger"
                                                                    ...
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       ...
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-blogger"
                                                                       id="sap-schedule-time-blogger" <?php echo !empty($sap_schedule_time_blogger) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_blogger) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime ">
                                                            </div>
                                                        <?php } // End of main if
                                                        ?>
                                            ...
                                            if (!empty($sap_wordpress_options['enable_wordpress'])) {
                                                ?>
                                                <div class="panel box wordpress-wrap">
                                                    <h4 class="box-title">
                                                        <?php echo $sap_common->lang('network_label_wordpress'); ?>
                                                        <div class="tg-list-item col-sm-6">
                                                            <input data-content="#quick_post_wordpress"
                                                                   class="tgl tgl-ios" <?php echo !empty($post_meta['wordpress']) ? 'checked="checked"' : ''; ?>
                                                                   name="networks[wordpress]" id="enable_wordpress"
                                                                   type="checkbox" value="1">
                                                            <label class="tgl-btn float-right-cs-init"
                                                                   for="enable_wordpress"></label>
                                                        </div>
                                                    </h4>
                                                    <?php $style = !empty($post_meta['wordpress']) ? 'display:block;' : 'display:none;'; ?>

                                                    <div id="quick_post_wordpress"
                                                         class="panel-collapse collapse wp-selector"
                                                         style="<?php echo $style; ?>">
                                                        ...
                                                        <?php } else {
                                                            ...
                                                            <div class="sap-msg-wrap">
                                                                <label for="sap_blogger_title"
                                                                       class="control-label"><?php echo $sap_common->lang('wordpress_custom_message'); ?></label>

                                                                <input type="text" name="networks[wordpress_title]"
                                                                       class="form-control sap_wordpress_title"
                                                                       id="sap_wordpress_title" tabindex="5"
                                                                       value="<?php echo (!empty($post_meta['wordpress_title'])) ? $post_meta['wordpress_title'] : ''; ?>"/>
                                                            </div>

                                                            <label for="sap_fb_user_id"
                                                                   class="control-label"><?php echo $sap_common->lang('select_accounts'); ?></label>
                                                            <select class="form-control sap_select" tabindex="6"
                                                                    name="networks[wordpress_accounts][]"
                                                                    multiple="multiple" id="sap_wordpress_user_id"
                                                                    data-placeholder="Select User">
                                                                <?php
                                                            ...
                                                            <div class="select-button">
                                                                <br>
                                                                <button type="button" class="btn btn-light deselect_all"
                                                                        data-parent="wp-selector"><?php echo $sap_common->lang('select_none'); ?></button>
                                                                <button type="button" name="sap_facebook_submit"
                                                                        class="btn btn-primary select_all"
                                                                        data-parent="wp-selector"> <?php echo $sap_common->lang('select_all'); ?></button>
                                                            </div>
                                                            <div class="sap-individual-time">
                                                                <label for="sap-schedule-time-wordpress"
                                                                    ...
                                                                    <i class="fa fa-question-circle sap-st-tooltip"
                                                                       ...
                                                                       data-trigger="hover" data-placement="right"
                                                                       data-content="This setting modifies the schedule global setting and overrides scheduled time. Keep it blank to use the global schedule settings."></i></label>
                                                                <input type="text" name="sap-schedule-time-wordpress"
                                                                       id="sap-schedule-time-wordpress" <?php echo !empty($sap_schedule_time_blogger) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time_blogger) . '"' : ''; ?>
                                                                       readonly="" class="form-control sap-datetime ">
                                                            </div>
                                                        <?php } // End of main if
                                                        ?>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-12 buttons buttons-display-flex button-amin-wrap sap-global-time-wrap d-flex">
                                    <label for="sap-schedule-time"
                                           class="col-sm-12 control-label"><?php echo $sap_common->lang('schedule_global'); ?>
                                        <i class="fa fa-question-circle sap-st-tooltip" data-container="body"
                                           data-toggle="popover" data-trigger="hover" data-placement="right"
                                           data-content="Enter schedule time to publish post on social media. This setting applies the schedule time for all the social media and it gets over-written if Schedule Individually is applied for any particular social media."></i></label>
                                    <div class="col-sm-12 ">
                                        <div class="col-lg-8 sap-global-time">
                                            <div class="form-group">
                                                <div class="" style="padding-left: 0px;">
                                                    <div class="d-flex align-items-center sap-schedule-clock">
                                                        <i class="fa fa-clock-o sap-schedule-icon"
                                                           aria-hidden="true"></i>
                                                        <input type="text" name="sap-schedule-time"
                                                               id="sap-schedule-time" <?php echo !empty($sap_schedule_time) ? 'value="' . date('Y-m-d H:i', $sap_schedule_time) . '"' : ''; ?>
                                                               readonly=""
                                                               class="form-control  sap-datetime sap-schedule-input">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4" style="padding-right: 0px;">
                                            <button type="submit" name="sap_quick_post_add"
                                                    class="sap_quick_post_add btn btn-success pull-right buttons-margin-left-auto"> <?php echo $sap_common->lang('publish_post'); ?></button>
                                            <button type="submit" name="sap_quick_post_update"
                                                    class="sap_quick_post_update btn btn-success pull-right"><?php echo $sap_common->lang('update_post'); ?></button>
                                        </div>
                                    </div>
